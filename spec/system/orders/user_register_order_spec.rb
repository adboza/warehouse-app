...
describe 'Usuário cadastra um pedido' do
  ...
  it 'com sucesso' do
    ...
    fill_in 'Data Prevista', with: 2.days.from_now
    click_on 'Gravar'
    #Assert
    ...
    expect(page).to have_content "Data Prevista de Entrega: #{I18n.localize(Order.last.estimated_delivery_date)}"
  end
  ...
  it 'com falha' do
    ...
    select 'GRU - Aeroporto SP', from: 'Galpão Destino'
    select supplier.full_description, from: 'Fornecedor' 
    fill_in 'Data Prevista', with: nil
    click_on 'Gravar'
    #Assert
